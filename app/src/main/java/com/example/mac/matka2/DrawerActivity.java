...
public class DrawerActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinnerGame=(Spinner) findViewById(R.id.spinerGame);
        ...
        //spinnerGame.setOnItemClickListener(ada);
        spinnerGame.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {

                String items=spinnerGame.getSelectedItem().toString();
                //Log.i("Selected item : ",items);
                Toast.makeText(getApplicationContext(),"Selected item : " + items,Toast.LENGTH_LONG).show();
                if (items.contains("Single Panna")){
